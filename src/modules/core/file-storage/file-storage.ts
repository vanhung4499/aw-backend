import { FileStorageOption, FileStorageProviderEnum } from '../../../models';
    ...
    if (isEmpty(providerName)) {
      ...
      if (request) {
        ...
        if (isEmpty(provider) || !providers.includes(provider)) {
          ...
          this.config.provider =
            provider.toUpperCase() as FileStorageProviderEnum;
        }
      } else {
        this.config.provider =
          (environment.fileSystem.name.toUpperCase() as FileStorageProviderEnum) ||
      ...
      if (providers.includes(providerName)) {
        this.config.provider =
          providerName.toUpperCase() as FileStorageProviderEnum;
      } else {
